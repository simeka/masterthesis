...
. The stimulation increases or decreases the membrane potential of the postsynaptic neuron of the  are then forwarded to the \emph{soma} where the information is processed (c.f. \cref{biosynapse}). 
